package com.youssef.ecomeraauthservice.common.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleJsonError(
        ...
        if (ex.getCause() instanceof InvalidFormatException ife && ife.getTargetType().isEnum()) {
            return handleInvalidEnumValue(ife, request);
        }

        return ResponseEntity.badRequest().body(
                ErrorResponse.of(400, BAD_REQUEST,
    ...
    private ResponseEntity<ErrorResponse> handleInvalidEnumValue(
            InvalidFormatException ife, HttpServletRequest request) {
        ...
        String message = String.format(
                ...
                ife.getValue(), field, allowed
        );

        return ResponseEntity.badRequest().body(
                ErrorResponse.of(400, BAD_REQUEST, message, request.getRequestURI())
        );
    }
