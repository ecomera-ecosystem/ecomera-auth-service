package com.ecomera.auth.config;
...
import static com.ecomera.auth.user.Permission.*;
import static com.ecomera.auth.user.Role.ADMIN;
import static com.ecomera.auth.user.Role.MANAGER;
